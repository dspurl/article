<template>
  <div class="app-container">
    <div class="filter-container">
      <router-link v-permission="$store.jurisdiction.ArticlePropertyCreate" :to="'ArticlePropertyCreate'">
    ...
    <el-table
      ...
      <el-table-column label="操作" class-name="small-padding fixed-width" width="250" fixed="right">
        <template slot-scope="scope">
          <router-link v-permission="$store.jurisdiction.ArticlePropertyEdit" :to="{ path: 'ArticlePropertyEdit', query: { id: scope.row.id }}">
            <el-tooltip class="item" effect="dark" content="编辑" placement="top-start">
              <el-button type="primary" icon="el-icon-edit" circle/>
            </el-tooltip>
          </router-link>
          <el-tooltip v-permission="$store.jurisdiction.ArticlePropertyDestroy" class="item" effect="dark" content="删除" placement="top-start">
    ...
    <div class="pagination-operation">
      <div class="operation">
        ...
        <el-button v-permission="$store.jurisdiction.ArticlePropertyDestroy" :loading="formLoading" size="mini" type="danger" @click="handleAllDelete()">删除</el-button>
      </div>
